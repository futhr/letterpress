...
export const contract = {
  ...
  profiles: {
    "email/mjml-liquid@1": {
      ...
      forbidden_elements: ["mj-include"],
      url_attributes: ["href", "src", "background-url", "action"],
      color_attributes: ["color", "background-color", "border-color"],
      text_elements: [
        "mj-text",
        "mj-button",
        "mj-title",
      ...
      structural_elements: ["mj-body", "mj-wrapper", "mj-section", "mj-group", "mj-column"],
      common_attributes: ["css-class", "mj-class"],
      element_metadata: {
        "mj-accordion": {
          attributes: {
            border: "string",
      ...
      nesting: {
        ...
        "mj-accordion-element": ["mj-accordion-text", "mj-accordion-title", "mj-raw"],
        "mj-accordion-text": [],
        "mj-accordion-title": [],
        "mj-attributes": ["*"],
        "mj-body": ["mj-hero", "mj-raw", "mj-section", "mj-wrapper"],
        "mj-button": [],
        ...
        "mj-social": ["mj-raw", "mj-social-element"],
        "mj-social-element": [],
        "mj-spacer": [],
        "mj-table": [],
        "mj-text": [],
  ...
  liquid: {
    tags: ["if", "unless", "for", "case", "comment", "break", "continue"],
    filters: [
      "abs",
      "append",
      "at_least",
    ...
    reserved_filters: ["letterpress_escape"],
  },
  embedded_html: {
    elements: [
      "a",
  ...
  contexts: ["text", "html_text", "html_attribute", "url", "color", "css", "subject", "none"],
  phases: ["compile", "delivery"],
  types: [
    "string",
    "integer",
    "number",
    ...
    email: [
      {
        ...
        template:
          "<mjml>\n  <mj-head>\n    <mj-preview>${1:Preview}</mj-preview>\n  </mj-head>\n  <mj-body>\n    <mj-section>\n      <mj-column>\n        <mj-text>${2:Content}</mj-text>\n      </mj-column>\n    </mj-section>\n  </mj-body>\n</mjml>",
      },
      {
    ...
    text: [
      {
        ...
        template: "{% if ${1:condition} %}${2:Text}{% endif %}",
      },
      {
        label: "variable",
        template: "{{ ${1:variable} }}",
  ...
  diagnostic_codes: [
    ...
    "LP_COMPILER_DISABLED",
    "LP_COMPILER_TIMEOUT",
    "LP_COMPILER_UNAVAILABLE",
    "LP_INPUT_INVALID",
    "LP_INTERNAL_BOUNDARY",
    ...
    "LP_PROFILE_INVALID",
    "LP_PROFILE_UNKNOWN",
    "LP_RENDER_INPUT_DEPTH",
    "LP_RENDER_INPUT_ITEMS",
    "LP_RENDER_INPUT_KEYS",
    "LP_RENDER_INPUT_SCALAR",
    "LP_RENDER_INVALID",
    "LP_RENDER_LIQUID",
    "LP_RENDER_LOOP_LIMIT",
    "LP_RENDER_OUTPUT_LIMIT",
    "LP_RENDER_RESOURCE_LIMIT",
    "LP_RENDER_TIMEOUT",
    "LP_RENDER_VALUE_INVALID",
    "LP_RENDER_VALUE_MISSING",
    "LP_RENDER_VALUE_UNKNOWN",
    "LP_SCHEMA_CONTEXT_MISMATCH",
    "LP_SCHEMA_DEFAULT",
    "LP_SCHEMA_DEFINITION",
    "LP_SCHEMA_DEPTH",
    "LP_SCHEMA_DESCRIPTION",
    "LP_SCHEMA_FIELD",
    "LP_SCHEMA_INVALID",
    "LP_SCHEMA_NAME",
    "LP_SCHEMA_PHASE",
  ...
  generated_from: {
    mjml: "5.4.0",
    source: "contract/letterpress-v1.json",
  },
} as const
