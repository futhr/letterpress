    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          # Aliases, pipes, rebinding, and long documentation follow the formatter's style;
          # duplicate-code and enumerable-cost heuristics are too noisy for this codebase.
